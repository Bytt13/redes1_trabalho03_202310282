...
/**************************************************************
  ...
  * ********************************************************* */
  public static int[] CamadaDeEnlaceReceptoraControleDeFluxo(int[] quadro) {
    ...
    switch(tipoDeFluxo) {
      case 0: //bit de paridade par
        quadroComFluxo = CamadaEnlaceDadosReceptoraJanelaDeslizanteUmBit(quadro);
        break;
      case 1: //bit de paridade impar
        quadroComFluxo = CamadaEnlaceDadosReceptoraJanelaDeslizanteGoBackN(quadro);
        break;
      case 2: //CRC
        quadroComFluxo = CamadaEnlaceDadosReceptoraJanelaDeslizanteComRetransmissaoSeletiva(quadro);
        break;
      default:
        quadroComFluxo = CamadaEnlaceDadosReceptoraJanelaDeslizanteUmBit(quadro);
        break;
  ...
  * ********************************************************* */
  public static int[] CamadaEnlaceDadosReceptoraJanelaDeslizanteUmBit(int[] quadro) {
    return quadro;
  } // fim do metodo
  /**************************************************************
  * Metodo: CamadaEnlaceDadosTransmissoraJanelaDeslizanteUmBit
  ...
  * @return int[] | quadro com fluxo 
  * ********************************************************* */
  public static int[] CamadaEnlaceDadosReceptoraJanelaDeslizanteGoBackN(int[] quadro) {
    return quadro;
  } // fim do metodo
  /**************************************************************
  * Metodo: CamadaEnlaceDadosTransmissoraJanelaDeslizanteUmBit
  ...
  * @return int[] | quadro com fluxo 
  * ********************************************************* */
  public static int[] CamadaEnlaceDadosReceptoraJanelaDeslizanteComRetransmissaoSeletiva(int[] quadro) {
    return quadro;
  } // fim do metodo
 /**************************************************************
